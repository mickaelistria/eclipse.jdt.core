...
class JavacBindingResolver extends BindingResolver {
	...
	private Queue<Env<AttrContext>> flowResult;
	...
	private void resolve() {
		if (this.symbolToDom == null) {
			...
			this.flowResult = this.javac.flow(attribute);
	...
	ASTNode findNode(Symbol symbol) {
		if (this.symbolToDom != null) {
...
//		}
	...
	IBinding getBinding(final Symbol owner) {

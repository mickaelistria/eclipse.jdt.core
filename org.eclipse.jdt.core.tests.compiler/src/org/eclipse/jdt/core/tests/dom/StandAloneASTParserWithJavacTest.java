...
public class StandAloneASTParserWithJavacTest extends AbstractRegressionTest {
	public StandAloneASTParserWithJavacTest(String name) {
		super(name);
	}
	...
	public void setUp() throws Exception {
		ASTParser.NEW_INSTANCE_USE_JAVAC = true;
		super.setUp();
	}
	...
	public void tearDown() throws Exception {
		ASTParser.NEW_INSTANCE_USE_JAVAC = false;
		super.tearDown();
	}
	...
	public void test1() {
		String contents =
				...
				"	}\n" +
				"}";
		ASTNode node = runConversion(AST_JLS_LATEST, contents, false, true, true, "p/X.java");
		assertTrue("Should be a compilation unit", node instanceof CompilationUnit);
		CompilationUnit unit = (CompilationUnit) node;

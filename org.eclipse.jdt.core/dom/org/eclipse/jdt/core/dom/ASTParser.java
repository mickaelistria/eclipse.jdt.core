...
public class ASTParser {
	...
	ASTParser(int level) {
		...
		this.apiLevel = level;
		this.unitResolver = getCompilationUnitResolverInstance();
		initializeDefaults();
	}

	@SuppressWarnings("unchecked")
	private static ICompilationUnitResolver getCompilationUnitResolverInstance() {
		String compilationUnitResolverClass = System.getProperty(ASTParser.class.getSimpleName() + ".compilationUnitResolver"); //$NON-NLS-1$
